    ...
    <>
      <form className='w-screen h-screen flex flex-col items-center justify-center gap-5 ' onSubmit={handleSubmit(handleSave)}>
        ...
        <div className='flex flex-col items-start gap-2 '>
          ...
          {...register("telefone")}
          id="telefone" />
             {errors.telefone && <p className='font-semibold text-red-600 text-left'>{errors.telefone.message}</p>}
        </div>
        ...
        <input type="submit" className=' w-96 py-2 px-3 cursor-pointer  bg-slate-700 font-semibold text-white rounded' value="Enviar" />
      </form>
    </>
  )
}
